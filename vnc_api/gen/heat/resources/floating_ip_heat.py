...
class ContrailFloatingIp(contrail.ContrailResource):
    PROPERTIES = (
        NAME, FQ_NAME, FLOATING_IP_ADDRESS_FAMILY, FLOATING_IP_PORT_MAPPINGS, FLOATING_IP_PORT_MAPPINGS_PORT_MAPPINGS, FLOATING_IP_PORT_MAPPINGS_PORT_MAPPINGS_SRC_PORT, FLOATING_IP_PORT_MAPPINGS_PORT_MAPPINGS_DST_PORT, FLOATING_IP_IS_VIRTUAL_IP, FLOATING_IP_ADDRESS, FLOATING_IP_PORT_MAPPINGS_ENABLE, DISPLAY_NAME, ANNOTATIONS, ANNOTATIONS_KEY_VALUE_PAIR, ANNOTATIONS_KEY_VALUE_PAIR_KEY, ANNOTATIONS_KEY_VALUE_PAIR_VALUE, FLOATING_IP_FIXED_IP_ADDRESS, PROJECT_REFS, VIRTUAL_MACHINE_INTERFACE_REFS, FLOATING_IP_POOL, INSTANCE_IP
    ) = (
        'name', 'fq_name', 'floating_ip_address_family', 'floating_ip_port_mappings', 'floating_ip_port_mappings_port_mappings', 'floating_ip_port_mappings_port_mappings_src_port', 'floating_ip_port_mappings_port_mappings_dst_port', 'floating_ip_is_virtual_ip', 'floating_ip_address', 'floating_ip_port_mappings_enable', 'display_name', 'annotations', 'annotations_key_value_pair', 'annotations_key_value_pair_key', 'annotations_key_value_pair_value', 'floating_ip_fixed_ip_address', 'project_refs', 'virtual_machine_interface_refs', 'floating_ip_pool', 'instance_ip'
    )
    ...
    def handle_create(self):
        ...
        if parent_obj is None and self.properties.get(self.FLOATING_IP_POOL):
            try:
                ...
                parent_obj = None
        if parent_obj is None and self.properties.get(self.INSTANCE_IP):
            try:
                parent_obj = self.vnc_lib().instance_ip_read(id=self.properties.get(self.INSTANCE_IP))
            except vnc_api.NoIdError:
