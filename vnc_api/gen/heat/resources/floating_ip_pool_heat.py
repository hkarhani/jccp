...
class ContrailFloatingIpPool(contrail.ContrailResource):
    PROPERTIES = (
        NAME, FQ_NAME, DISPLAY_NAME, ANNOTATIONS, ANNOTATIONS_KEY_VALUE_PAIR, ANNOTATIONS_KEY_VALUE_PAIR_KEY, ANNOTATIONS_KEY_VALUE_PAIR_VALUE, FLOATING_IP_POOL_PREFIXES, FLOATING_IP_POOL_PREFIXES_SUBNET, FLOATING_IP_POOL_PREFIXES_SUBNET_IP_PREFIX, FLOATING_IP_POOL_PREFIXES_SUBNET_IP_PREFIX_LEN, VIRTUAL_NETWORK
    ) = (
        'name', 'fq_name', 'display_name', 'annotations', 'annotations_key_value_pair', 'annotations_key_value_pair_key', 'annotations_key_value_pair_value', 'floating_ip_pool_prefixes', 'floating_ip_pool_prefixes_subnet', 'floating_ip_pool_prefixes_subnet_ip_prefix', 'floating_ip_pool_prefixes_subnet_ip_prefix_len', 'virtual_network'
    )
