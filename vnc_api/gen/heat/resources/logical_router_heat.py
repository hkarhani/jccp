...
class ContrailLogicalRouter(contrail.ContrailResource):
    PROPERTIES = (
        NAME, FQ_NAME, DISPLAY_NAME, CONFIGURED_ROUTE_TARGET_LIST, CONFIGURED_ROUTE_TARGET_LIST_ROUTE_TARGET, ANNOTATIONS, ANNOTATIONS_KEY_VALUE_PAIR, ANNOTATIONS_KEY_VALUE_PAIR_KEY, ANNOTATIONS_KEY_VALUE_PAIR_VALUE, VIRTUAL_NETWORK_REFS, SERVICE_INSTANCE_REFS, ROUTE_TABLE_REFS, VIRTUAL_MACHINE_INTERFACE_REFS, ROUTE_TARGET_REFS, PROJECT
    ) = (
        'name', 'fq_name', 'display_name', 'configured_route_target_list', 'configured_route_target_list_route_target', 'annotations', 'annotations_key_value_pair', 'annotations_key_value_pair_key', 'annotations_key_value_pair_value', 'virtual_network_refs', 'service_instance_refs', 'route_table_refs', 'virtual_machine_interface_refs', 'route_target_refs', 'project'
    )
