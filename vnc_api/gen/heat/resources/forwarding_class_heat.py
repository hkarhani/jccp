...
class ContrailForwardingClass(contrail.ContrailResource):
    PROPERTIES = (
        NAME, FQ_NAME, DISPLAY_NAME, FORWARDING_CLASS_VLAN_PRIORITY, FORWARDING_CLASS_MPLS_EXP, FORWARDING_CLASS_ID, FORWARDING_CLASS_DSCP, ANNOTATIONS, ANNOTATIONS_KEY_VALUE_PAIR, ANNOTATIONS_KEY_VALUE_PAIR_KEY, ANNOTATIONS_KEY_VALUE_PAIR_VALUE, QOS_QUEUE_REFS, GLOBAL_QOS_CONFIG
    ) = (
        'name', 'fq_name', 'display_name', 'forwarding_class_vlan_priority', 'forwarding_class_mpls_exp', 'forwarding_class_id', 'forwarding_class_dscp', 'annotations', 'annotations_key_value_pair', 'annotations_key_value_pair_key', 'annotations_key_value_pair_value', 'qos_queue_refs', 'global_qos_config'
    )
