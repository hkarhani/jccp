...
class ContrailAnalyticsNode(contrail.ContrailResource):
    PROPERTIES = (
        NAME, FQ_NAME, ANALYTICS_NODE_IP_ADDRESS, DISPLAY_NAME, ANNOTATIONS, ANNOTATIONS_KEY_VALUE_PAIR, ANNOTATIONS_KEY_VALUE_PAIR_KEY, ANNOTATIONS_KEY_VALUE_PAIR_VALUE, GLOBAL_SYSTEM_CONFIG
    ) = (
        'name', 'fq_name', 'analytics_node_ip_address', 'display_name', 'annotations', 'annotations_key_value_pair', 'annotations_key_value_pair_key', 'annotations_key_value_pair_value', 'global_system_config'
    )
