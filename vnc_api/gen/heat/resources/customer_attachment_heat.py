...
class ContrailCustomerAttachment(contrail.ContrailResource):
    PROPERTIES = (
        NAME, FQ_NAME, ATTACHMENT_ADDRESS, DISPLAY_NAME, ANNOTATIONS, ANNOTATIONS_KEY_VALUE_PAIR, ANNOTATIONS_KEY_VALUE_PAIR_KEY, ANNOTATIONS_KEY_VALUE_PAIR_VALUE, FLOATING_IP_REFS, VIRTUAL_MACHINE_INTERFACE_REFS
    ) = (
        'name', 'fq_name', 'attachment_address', 'display_name', 'annotations', 'annotations_key_value_pair', 'annotations_key_value_pair_key', 'annotations_key_value_pair_value', 'floating_ip_refs', 'virtual_machine_interface_refs'
    )
