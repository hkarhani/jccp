...
class ContrailServiceApplianceSet(contrail.ContrailResource):
    PROPERTIES = (
        NAME, FQ_NAME, DISPLAY_NAME, SERVICE_APPLIANCE_DRIVER, SERVICE_APPLIANCE_SET_PROPERTIES, SERVICE_APPLIANCE_SET_PROPERTIES_KEY_VALUE_PAIR, SERVICE_APPLIANCE_SET_PROPERTIES_KEY_VALUE_PAIR_KEY, SERVICE_APPLIANCE_SET_PROPERTIES_KEY_VALUE_PAIR_VALUE, SERVICE_APPLIANCE_HA_MODE, ANNOTATIONS, ANNOTATIONS_KEY_VALUE_PAIR, ANNOTATIONS_KEY_VALUE_PAIR_KEY, ANNOTATIONS_KEY_VALUE_PAIR_VALUE, GLOBAL_SYSTEM_CONFIG
    ) = (
        'name', 'fq_name', 'display_name', 'service_appliance_driver', 'service_appliance_set_properties', 'service_appliance_set_properties_key_value_pair', 'service_appliance_set_properties_key_value_pair_key', 'service_appliance_set_properties_key_value_pair_value', 'service_appliance_ha_mode', 'annotations', 'annotations_key_value_pair', 'annotations_key_value_pair_key', 'annotations_key_value_pair_value', 'global_system_config'
    )
