                                ...
                                schema={
                                    ...
                                    SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO: properties.Schema(
                                        ...
                                        schema={
                                            ...
                                            SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_ANALYZER_MAC_ADDRESS: properties.Schema(
                                                properties.Schema.STRING,
                                                _('SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_ANALYZER_MAC_ADDRESS.'),
                                                update_allowed=True,
                                                required=False,
                                            ),
                                            ...
                                            SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_JUNIPER_HEADER: properties.Schema(
                                                properties.Schema.BOOLEAN,
                                                _('SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_JUNIPER_HEADER.'),
                                                update_allowed=True,
                                                required=False,
                                            ),
                                            SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_NH_MODE: properties.Schema(
                                                properties.Schema.STRING,
                                                _('SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_NH_MODE.'),
                                                update_allowed=True,
                                                required=False,
                                                constraints=[
                                            ...
                                            SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER: properties.Schema(
                                                properties.Schema.MAP,
                                                _('SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER.'),
                                                update_allowed=True,
                                                required=False,
                                                schema={
                                                    SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER_VTEP_DST_IP_ADDRESS: properties.Schema(
                                                        properties.Schema.STRING,
                                                        _('SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER_VTEP_DST_IP_ADDRESS.'),
                                                        update_allowed=True,
                                                        required=False,
                                                    ),
                                                    SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER_VTEP_DST_MAC_ADDRESS: properties.Schema(
                                                        properties.Schema.STRING,
                                                        _('SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER_VTEP_DST_MAC_ADDRESS.'),
                                                        update_allowed=True,
                                                        required=False,
                                                    ),
                                                    SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER_VNI: properties.Schema(
                                                        properties.Schema.INTEGER,
                                                        _('SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER_VNI.'),
                                                        update_allowed=True,
                                                        required=False,
                                                    ),
                                                }
                ...
                for index_1 in range(len(self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE))):
                    ...
                    if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST) is not None:
                        ...
                        if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO) is not None:
                            ...
                            if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_ANALYZER_MAC_ADDRESS) is not None:
                                obj_4.set_analyzer_mac_address(self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_ANALYZER_MAC_ADDRESS))
                            ...
                            if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_JUNIPER_HEADER) is not None:
                                obj_4.set_juniper_header(self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_JUNIPER_HEADER))
                            if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_NH_MODE) is not None:
                                obj_4.set_nh_mode(self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_NH_MODE))
                            if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER) is not None:
                                obj_5 = vnc_api.StaticMirrorNhType()
                                if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER_VTEP_DST_IP_ADDRESS) is not None:
                                    obj_5.set_vtep_dst_ip_address(self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER_VTEP_DST_IP_ADDRESS))
                                if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER_VTEP_DST_MAC_ADDRESS) is not None:
                                    obj_5.set_vtep_dst_mac_address(self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER_VTEP_DST_MAC_ADDRESS))
                                if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER_VNI) is not None:
                                    obj_5.set_vni(self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER_VNI))
                ...
                for index_1 in range(len(prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE))):
                    ...
                    if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST) is not None:
                        ...
                        if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO) is not None:
                            ...
                            if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_ANALYZER_MAC_ADDRESS) is not None:
                                obj_4.set_analyzer_mac_address(prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_ANALYZER_MAC_ADDRESS))
                            ...
                            if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_JUNIPER_HEADER) is not None:
                                obj_4.set_juniper_header(prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_JUNIPER_HEADER))
                            if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_NH_MODE) is not None:
                                obj_4.set_nh_mode(prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_NH_MODE))
                            if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER) is not None:
                                obj_5 = vnc_api.StaticMirrorNhType()
                                if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER_VTEP_DST_IP_ADDRESS) is not None:
                                    obj_5.set_vtep_dst_ip_address(prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER_VTEP_DST_IP_ADDRESS))
                                if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER_VTEP_DST_MAC_ADDRESS) is not None:
                                    obj_5.set_vtep_dst_mac_address(prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER_VTEP_DST_MAC_ADDRESS))
                                if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER_VNI) is not None:
                                    obj_5.set_vni(prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_MIRROR_TO_STATIC_NH_HEADER_VNI))
                                obj_4.set_static_nh_header(obj_5)
                            obj_3.set_mirror_to(obj_4)
