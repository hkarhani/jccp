...
class ContrailProject(contrail.ContrailResource):
    PROPERTIES = (
        NAME, FQ_NAME, DISPLAY_NAME, QUOTA, QUOTA_DEFAULTS, QUOTA_FLOATING_IP, QUOTA_INSTANCE_IP, QUOTA_VIRTUAL_MACHINE_INTERFACE, QUOTA_VIRTUAL_NETWORK, QUOTA_VIRTUAL_ROUTER, QUOTA_VIRTUAL_DNS, QUOTA_VIRTUAL_DNS_RECORD, QUOTA_BGP_ROUTER, QUOTA_NETWORK_IPAM, QUOTA_ACCESS_CONTROL_LIST, QUOTA_NETWORK_POLICY, QUOTA_FLOATING_IP_POOL, QUOTA_SERVICE_TEMPLATE, QUOTA_SERVICE_INSTANCE, QUOTA_LOGICAL_ROUTER, QUOTA_SECURITY_GROUP, QUOTA_SECURITY_GROUP_RULE, QUOTA_SUBNET, QUOTA_GLOBAL_VROUTER_CONFIG, QUOTA_LOADBALANCER_POOL, QUOTA_LOADBALANCER_MEMBER, QUOTA_LOADBALANCER_HEALTHMONITOR, QUOTA_VIRTUAL_IP, ALARM_ENABLE, ANNOTATIONS, ANNOTATIONS_KEY_VALUE_PAIR, ANNOTATIONS_KEY_VALUE_PAIR_KEY, ANNOTATIONS_KEY_VALUE_PAIR_VALUE, NAMESPACE_REFS, NAMESPACE_REFS_DATA, NAMESPACE_REFS_DATA_IP_PREFIX, NAMESPACE_REFS_DATA_IP_PREFIX_LEN, FLOATING_IP_POOL_REFS, ALIAS_IP_POOL_REFS, DOMAIN
    ) = (
        'name', 'fq_name', 'display_name', 'quota', 'quota_defaults', 'quota_floating_ip', 'quota_instance_ip', 'quota_virtual_machine_interface', 'quota_virtual_network', 'quota_virtual_router', 'quota_virtual_dns', 'quota_virtual_dns_record', 'quota_bgp_router', 'quota_network_ipam', 'quota_access_control_list', 'quota_network_policy', 'quota_floating_ip_pool', 'quota_service_template', 'quota_service_instance', 'quota_logical_router', 'quota_security_group', 'quota_security_group_rule', 'quota_subnet', 'quota_global_vrouter_config', 'quota_loadbalancer_pool', 'quota_loadbalancer_member', 'quota_loadbalancer_healthmonitor', 'quota_virtual_ip', 'alarm_enable', 'annotations', 'annotations_key_value_pair', 'annotations_key_value_pair_key', 'annotations_key_value_pair_value', 'namespace_refs', 'namespace_refs_data', 'namespace_refs_data_ip_prefix', 'namespace_refs_data_ip_prefix_len', 'floating_ip_pool_refs', 'alias_ip_pool_refs', 'domain'
    )
