...
class GlobalVrouterConfigTestFixtureGen(cfixture.ContrailFixture):
    ...
    """
    def __init__(self, conn_drv, global_vrouter_config_name=None, parent_fixt=None, auto_prop_val=False, linklocal_services=None, encapsulation_priorities=None, vxlan_network_identifier_mode=None, forwarding_mode=None, id_perms=None, display_name=None):
        '''
...
class InstanceIpTestFixtureGen(cfixture.ContrailFixture):
    ...
    """
    def __init__(self, conn_drv, instance_ip_name=None, auto_prop_val=False, virtual_network_refs = None, virtual_machine_interface_refs = None, instance_ip_address=None, instance_ip_family=None, instance_ip_mode=None, subnet_uuid=None, instance_ip_secondary=None, id_perms=None, display_name=None):
        '''
...
class LoadbalancerPoolTestFixtureGen(cfixture.ContrailFixture):
    ...
    """
    def __init__(self, conn_drv, loadbalancer_pool_name=None, parent_fixt=None, auto_prop_val=False, service_instance_refs = None, virtual_machine_interface_refs = None, service_appliance_set_refs = None, loadbalancer_healthmonitor_refs = None, loadbalancer_pool_properties=None, loadbalancer_pool_provider=None, loadbalancer_pool_custom_attributes=None, id_perms=None, display_name=None):
        '''
