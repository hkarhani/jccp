...
RUN pip install --upgrade pip && git clone https://github.com/Juniper/py-space-platform.git && pip install ./py-space-platform && pip install jxmlease && pip install jupyter && pip install shade python-openstackclient && pip install python-keystoneclient && pip install python-heatclient && pip install python-novaclient && pip install python-glanceclient && pip install python-cinderclient && pip install python-swiftclient && pip install python-neutronclient
